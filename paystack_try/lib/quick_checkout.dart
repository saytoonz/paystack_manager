...
class PayWithMomoPage extends StatefulWidget {
  PayWithMomoPage({
    Key key,
    @required this.paymentInfo,
    @required this.optionToUse,
  }) : super(key: key);

  final PaymentInfo paymentInfo;
  final PaymentOption optionToUse;

  @override
  _PayWithMomoPageState createState() => _PayWithMomoPageState();
}

class _PayWithMomoPageState extends State<PayWithMomoPage> {
  ...
  void initState() {
    super.initState();
    _selectedPaymentOption = widget.optionToUse;
  }
  ...
  void _updatedViewState(
      TransactionState transactionState, String transactionStateMessage,
